...
public enum RejectedFileHeaders {
	...
	Language("Language"), ParentCategory("Parent Category"), ChildCategory1("Subcategory Level 1"), 
	Subcategory("Subcategory Level 2"),
	ISBN10("ISBN10"), MRP("MRP"),SellingPrice("SELLING PRICE"), Inventory("Inventory"), Weight("Weight (g)"), 
	Length("Length (cm)"),
